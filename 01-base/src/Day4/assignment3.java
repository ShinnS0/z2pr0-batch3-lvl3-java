...
public class assignment3 {
	...
	public static void main(String[] args) {
		...
		String [] brands = {"CPU","lenovo","hp","samsung","acer","dell","asus"};
...
//		System.out.println("Now, Current exchange rate : ");
//		double Currex = sc.nextDouble();
		
//		double ls = price * Currex;
//		System.out.println("The total amount of price (MMK) : " + ls);
	}
